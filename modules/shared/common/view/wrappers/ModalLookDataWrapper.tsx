...
export default function ModalLookDataWrapper({children}:ModalLookDataWrapperProps) {
      ...
      <Dialog as="div" className="relative z-50 focus:outline-none" onClose={handleClose}>
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4">
            <DialogPanel
              transition
              className="w-full max-w-md rounded-2xl bg-[#121212] p-6 border border-white/10 shadow-2xl duration-300 ease-out data-closed:transform data-closed:scale-95 data-closed:opacity-0"
            >
              {title && (
