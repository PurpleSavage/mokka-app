...
export default function ModalLookDataWrapper({
  children,
  size = "max-w-md",
  modalId,
}: ModalLookDataWrapperProps) {
  const dispatch = useDispatch();
  const {
    isVisible,
    modalId: activeModalId,
    title,
  } = useSelector((state: RootState) => state.modals.modalWrapper);
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4">
            <DialogPanel
              ...
              bg-table-body-bg p-6 text-left align-middle border
